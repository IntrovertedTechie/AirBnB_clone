...
![Airbnb logo image](./soba/logo.png)
## About
This project is a clone of Airbnb, a platform used to connect people who want to rent homes. It was built as part of a learning effort at ALX School.
## Console
...
```
## Project Structure
![Data diagram](./soba/structure.png)
